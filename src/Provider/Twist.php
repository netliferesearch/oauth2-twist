<?php namespace Netliferesearch\OAuth2\Client\Provider;
...
class Twist extends AbstractProvider
{
     ...
     * @param AccessToken $token
     * @return TwistResourceOwner
     */
    protected function createResourceOwner(array $response, AccessToken $token)
    {
        return new TwistResourceOwner($response);
    }
}
